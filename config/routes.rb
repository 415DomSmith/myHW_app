...
#       course_assignments POST   /api/courses/:course_id/assignments(.:format)     assignments#create
#        course_assignment GET    /api/courses/:course_id/assignments/:id(.:format) assignments#show
#                          PATCH  /api/courses/:course_id/assignments/:id(.:format) assignments#update
#                          PUT    /api/courses/:course_id/assignments/:id(.:format) assignments#update
#                          DELETE /api/courses/:course_id/assignments/:id(.:format) assignments#destroy
#                  courses POST   /api/courses(.:format)                            courses#create
#                   course GET    /api/courses/:id(.:format)                        courses#show
#                          PATCH  /api/courses/:id(.:format)                        courses#update
#                          PUT    /api/courses/:id(.:format)                        courses#update
#                          DELETE /api/courses/:id(.:format)                        courses#destroy
