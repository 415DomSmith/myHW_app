...
A class assignment management tool that allows Teachers to assign electronic documents, either uploaded to our app or pulled down from google drive. Teachers can track and grade assignments, and maintain a classroom grade book for each student.
